      ...
      case 'details':
        return (
          <div className="content-box">
            ...
            <p><strong>Role:</strong> Example Role</p>
      ...
      case 'projects':
        return (
            <div className="content-box">
              ...
              <div className="add-project-btn" onClick={() => navigate('/src/html-pages/projectSearch.html')}>
    ...
    <div className="ip-container">
        ...
        <div className="column-container">
            <div className="left-column">
                ...
                <button className={`tab-btn ${activeTab === 'searches' ? 'active' : ''}`} onClick={() => setActiveTab('searches')}>Saved Searched</button>
